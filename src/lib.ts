...
export function createDefaultState(now = new Date()): AppState {
  ...
  return {
    version: 2,
    profile: { name: "", email: "", emailProvider: "gmail", avatarMode: "preset", selectedAvatarId: "sailor-moon", uploadedAvatarDataUrl: null, notificationPreference: "unknown", soundEnabled: false, reducedEffects: false },
